...
time = 0
g = 9.8
height = abs(floor_pos[1] - sphere_pos[1]) # = (1/2)*g*time^2
total_time = math.sqrt(height*2/g)
print(total_time)
...
camera.SetPosition(0,sphere_pos[1],sphere_pos[1]*5)
